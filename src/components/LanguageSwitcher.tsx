...
const flags: Record<Lang, { label: string; emoji: string; title: string }> = {
  cs: { label: "CZ", emoji: "🇨🇿", title: "Čeština" },
  en: { label: "EN", emoji: "🇬🇧", title: "English" },
  de: { label: "DE", emoji: "🇩🇪", title: "Deutsch" },
};
